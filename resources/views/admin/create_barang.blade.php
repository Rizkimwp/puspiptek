                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                <select name="kategori_id" id="categori" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" rows="3"
                                            name="deskripsi" id="deskripsi" value="{{old('deskripsi')}}"></textarea>
                                    </div>
                                    @error('deskripsi')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('harga') is-invalid @enderror"
                                            placeholder="mohon masukan" name="harga" id="harga"
                                            value="{{old('harga')}}">
                                    </div>
                                    @error('harga')
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control @error('stok') is-invalid @enderror"
                                            placeholder="mohon masukan" name="stok" id="stok" value="{{old('stok')}}">
                                    </div>
                                    @error('stok')
                                    <div class="invalid-feedback">
                                        {{$message}}
